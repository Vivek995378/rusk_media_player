...
class VideoFeedPremiumLoader extends StatefulWidget {
  ...
  @override
  State<VideoFeedPremiumLoader> createState() =>
      _VideoFeedPremiumLoaderState();
}

class _VideoFeedPremiumLoaderState
    extends State<VideoFeedPremiumLoader>
      ...
      builder: (context, _) {
        ...
        return Stack(
          children: [
            ...
            /// 🎯 Center Play Button
            Center(
              child: _PlayButton(progress: progress),
            ),
